            ...
            switch (_a.label) {
                case 0:
                    transporter = nodemailer.createTransport({
                        host: 'smtp.gmail.com', // SMTP host  smtp.office365.com
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error sending email:', error_1); // Log any error
                    return [3 /*break*/, 4];
